// ============================================================
//  lib/screens/player_screen.dart  (version AudioController)
// ============================================================
...
class _PlayerScreenState extends State<PlayerScreen> {
      ...
      body: SafeArea(
        child: Column(
          children: [
            ...
            // Mini lecteur supprimé ici → GlobalMiniPlayer dans HomeScreen
          ],
        ),
      ),
    );
  ...
  Widget _buildBody() {
      ...
      return Center(
        child: Column(
          ...
          children: [
            ...
            Text(_erreur!,
                style:
                    GoogleFonts.syne(color: AppColors.textSecondary)),
            const SizedBox(height: 16),
            TextButton(
              onPressed: () {
                setState(
                    () { _loadingData = true; _erreur = null; });
                _loadSourates();
              },
    ...
    return ListView.builder(
      ...
      itemBuilder: (_, i) =>
          _buildSourateItem(_souratesFiltrees[i]),
    );
  }
